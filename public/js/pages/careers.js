    ...
    root.innerHTML = `
        <div class="container section">
            <div style="text-align: center; margin-bottom: 40px;">
                <h1 class="section-title" style="margin-bottom: 10px;">Careers at Roeder Implement</h1>
                <p style="color: var(--text-muted); font-size: 1.1rem; max-width: 600px; margin: 0 auto;">
                    Join our team of dedicated professionals. We are always looking for passionate individuals to help us serve our farming community.
                </p>
            </div>
                ...
                container.innerHTML = `
                    <div class="glass-card" style="text-align: center; padding: 40px;">
                        ...
                        <p style="color: var(--text-muted);">
                            ...
                            Feel free to send your resume to <strong>careers@roederimplement.com</strong>.
                        </p>
                    </div>
                `;
                return;
            ...
            container.innerHTML = jobs.reverse().map(job => `
                <div class="glass-card" style="padding: 30px;">
                    <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 15px;">
                        ...
                        <a href="mailto:careers@roederimplement.com?subject=Application for ${encodeURIComponent(job.title)}" class="btn btn-primary" style="padding: 10px 20px;">
                            Apply Now
                        </a>
                    </div>
            ...
            const jsonLdScripts = jobs.map(job => {
                const schema = {
                    ...
                    "hiringOrganization": {
                        "@type": "Organization",
                        "name": "Roeder Implement",
                        "sameAs": "http://www.roederimplement.com",
                        "logo": "http://www.roederimplement.com/assets/Uploads/RoederLogo.png"
                    },
                    "jobLocation": {
                        "@type": "Place",
                        "address": {
