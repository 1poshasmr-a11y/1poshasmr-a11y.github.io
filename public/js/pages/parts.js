export const renderPartsPage = (root) => {
                ...
                <form id="partsForm">
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 20px;">
                        <div class="form-group">
                            ...
                            <input type="text" name="make" class="form-control" placeholder="e.g. Case IH" required>
                        </div>
                        <div class="form-group">
                            <label class="form-label">Model</label>
                            <input type="text" name="model" class="form-control" placeholder="e.g. Magnum 340" required>
                        </div>
                        <div class="form-group">
    ...
    document.getElementById('partsForm').addEventListener('submit', async (e) => {
        ...
        try {
            await fetch('/api/parts-requests', {
                method: 'POST',
