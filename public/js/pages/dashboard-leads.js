            ...
            tbody.innerHTML = leads.reverse().map(lead => `
                <tr style="border-bottom: 1px solid rgba(255,255,255,0.05);">
                    ...
                    <td style="padding: 16px;">
                        ...
                        <span style="color: var(--text-muted); font-size: 0.85rem;">${lead.phone} | ${lead.email}</span>
                    </td>
                    <td style="padding: 16px;">
                        ${lead.make} ${lead.model} ${lead.year ? `(${lead.year})` : ''}
                        ${lead.tradeIn ? `<br><span style="color: var(--text-muted); font-size: 0.85rem;">Trade: ${lead.condition}, ${lead.hours} hrs</span>` : ''}
                    </td>
                    <td style="padding: 16px;">
